function highlightHTMLContent(htmlContent, plainText, plainTextPositions) {
    ...
    for (const position of plainTextPositions) {
      ...
      const markedContent = '<mark>${plainText.substring(start, end)}</mark>';
      const regex = new RegExp(plainText.substring(start, end), 'g');
      htmlContent = htmlContent.replace(regex, markedContent);
    }
